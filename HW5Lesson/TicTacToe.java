...
class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (!map.trySetCell(ai.turn(valueMap.getValueMap()), 'y')) // Ai trying to make a move
            map.print();
...
class Human {                                                 // Class for the player
    private final char DOT_X;
    private Scanner sc = new Scanner(System.in);

    Human(final char DOT_X){
        this.DOT_X = DOT_X;
    }
...
class Ai {                                                   // Class for AI

    private final char DOT_Y;
    private final int MAP_SIZE, WIN_ROW;
    private Random rand = new Random();

    Ai(int MAP_SIZE, int WIN_ROW, char DOT_Y) {
        this.DOT_Y = DOT_Y;
        this.MAP_SIZE = MAP_SIZE;
        this.WIN_ROW = WIN_ROW;
    }
...
class ValueMap {                                                   // Class for the valueMap needed for AI to make a choise
    
    private final char DOT_X, DOT_Y, DOT_EMPTY;
    private final int MAP_SIZE, WIN_ROW;
